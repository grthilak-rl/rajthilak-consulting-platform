...
const MOCK_CASE_STUDIES: CaseStudy[] = [
  {
    ...
    industry: "AI / ML",
    technologies: [{ name: "Python", category: "Language" }, { name: "TensorFlow", category: "AI & ML" }],
    featured: true,
  ...
  },
  {
    ...
    industry: "Healthcare",
    technologies: [{ name: "Java", category: "Language" }, { name: "Spring", category: "Framework" }],
    featured: false,
  ...
  },
  {
    ...
    industry: "Finance",
    technologies: [{ name: "Ruby", category: "Language" }],
    featured: false,
